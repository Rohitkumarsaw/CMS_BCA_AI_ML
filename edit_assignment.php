...
$assign_id = isset($_GET['id']) ? (int)$_GET['id'] : 0;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['file']) && $_FILES['file']['error'] === UPLOAD_ERR_OK) {
        $new_file = uploadFile($_FILES['file'], 'assignments', ALLOWED_NOTE_TYPES);
        if ($new_file === false) {
    ...
    if (empty($errors)) {
        ...
        logActivity($pdo, $user_id, $_SESSION['user_name'] ?? 'User', 'Updated', 'Assignment', $assign_id, $detail);
        redirect('assignment.php');
    }
}
    ...
    <div class="app-content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="mb-1"><i class="fas fa-edit me-2 text-primary"></i>Edit Assignment</h4>
                            ...
                            <form method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control" id="due_date" name="due_date" 
                                               value="<?= $record['due_date'] ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="status" name="status" list="status_list" required value="<?= htmlspecialchars($record['status'] ?? '') ?>" placeholder="Submitted, Not Submitted, Pending, or custom">
                                    </div>
